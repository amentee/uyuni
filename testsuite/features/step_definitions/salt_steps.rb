...
Given(/^I create a user with name "([^"]*)" and password "([^"]*)"/) do |user, password|
  ...
  $username = user
  $password = password
  $api_test.user.create($username, $password, $username, $username, 'test@mail.com')
  $api_test.user.add_role($username, 'satellite_admin')
  $api_test.user.add_role($username, 'org_admin')
  $api_test.user.add_role($username, 'channel_admin')
  $api_test.user.add_role($username, 'config_admin')
  $api_test.user.add_role($username, 'system_group_admin')
  $api_test.user.add_role($username, 'activation_key_admin')
  $api_test.user.add_role($username, 'image_admin')
